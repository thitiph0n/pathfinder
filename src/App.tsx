    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-base-200">
        <div className="max-w-lg w-full mx-4 space-y-4 text-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-error opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Error">
            <title>Error</title>
          ...
          <div>
            ...
            <p className="opacity-60 mt-1">The app couldn't load its configuration. Please contact your administrator.</p>
          </div>
